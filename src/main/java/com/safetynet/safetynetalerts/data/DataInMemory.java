 ...
 * 
 * if (globalRepository == null) { try {
 * 
 * globalRepository = new DataReader(new PersonRepositoryImpl(), new
 * FireStationRepositoryImpl(), new MedicalRecordRepositoryImpl()); } catch
